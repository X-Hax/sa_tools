...
namespace SADXObjectDefinitions.Common
{
    public class Wall : ObjectDefinition
    {
        ...
        public override HitResult CheckHit(SETItem item, Vector3 Near, Vector3 Far, Viewport Viewport, Matrix Projection, Matrix View, MatrixStack transform)
        {
            ...
            transform.Push();
            transform.TranslateLocal(0, 0, 10);
            transform.ScaleLocal(0.1000000014901161f, 0.1000000014901161f, 2);
            result = HitResult.Min(result, model.CheckHit(Near, Far, Viewport, Projection, View, transform, meshes));
            transform.Pop();
            transform.Push();
            transform.TranslateLocal(0, 0, 20);
            transform.RotateXYZLocal(0x2000, 0, 0);
            transform.TranslateLocal(0, 0, -3);
            transform.ScaleLocal(0.1000000014901161f, 0.1000000014901161f, 0.699999988079071f);
            result = HitResult.Min(result, model.CheckHit(Near, Far, Viewport, Projection, View, transform, meshes));
            transform.Pop();
            transform.Push();
            transform.TranslateLocal(0, 0, 20);
            transform.RotateXYZLocal(0xE000, 0, 0);
            transform.TranslateLocal(0, 0, -3);
            transform.ScaleLocal(0.1000000014901161f, 0.1000000014901161f, 0.699999988079071f);
            result = HitResult.Min(result, model.CheckHit(Near, Far, Viewport, Projection, View, transform, meshes));
            transform.Pop();
            transform.ScaleLocal((item.Scale.X + 10) / 5f, (item.Scale.Y + 10) / 5f, 0.1000000014901161f);
            result = HitResult.Min(result, model.CheckHit(Near, Far, Viewport, Projection, View, transform, meshes));
            transform.Pop();
            return result;
        }
