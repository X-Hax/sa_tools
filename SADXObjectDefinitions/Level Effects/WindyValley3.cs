...
namespace SADXObjectDefinitions.Level_Effects
{
    class WindyValley3 : LevelDefinition
    {
        ...
        public override void Init(Dictionary<string, string> data, byte act, Device dev)
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                models[i] = SonicRetro.SAModel.Object.LoadFromFile("Levels/Windy Valley/Act 3/Skybox model " + (i + 1).ToString(System.Globalization.NumberFormatInfo.InvariantInfo) + ".sa1mdl");
