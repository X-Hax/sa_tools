...
namespace SAModel.SALVL
{
	...
	public partial class MainForm : Form
	{
		...
		public void GetEditedLights(List<SADXStageLightData> stageLightsNew, List<LSPaletteData> charLightsNews)
		{
			stageLightList = new List<SADXStageLightData>();
			for (int i = 0; i < stageLightsNew.Count; i++)
				stageLightList.Add(stageLightsNew[i]);
