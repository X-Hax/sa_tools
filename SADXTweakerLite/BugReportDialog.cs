    ...
    public partial class BugReportDialog : Form
    {
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    if (MessageBox.Show(this, "Bug report submitted successfully!\n\nWould you like to go to the bug page?", "SADXTweakerLite Bug Report", MessageBoxButtons.YesNo, MessageBoxIcon.Information) == System.Windows.Forms.DialogResult.Yes)
                        System.Diagnostics.Process.Start("http://mm.reimuhakurei.net/?page=bugs&id=" + sr.ReadLine());
                }
                else
                {
                    if (rs.CanSeek) rs.Seek(0, SeekOrigin.Begin);
                    MessageBox.Show(this, "Bug report failed!\n\n" + sr.ReadToEnd(), "SADXTweakerLite Bug Report Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
                sr.Close();
                rs.Close();
            }
