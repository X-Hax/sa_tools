...
namespace SAFontEdit
{
	public partial class FileTypeDialog : Form
	{
		...
		public FileTypeDialog(string filename)
		{
			...
			InitializeComponent();
			Shown += FileTypeDialog_Shown;
		}

		private void FileTypeDialog_Shown(object sender, EventArgs e)
		{
			GuessData(guess_filename);
		}
		...
		private void buttonLoadCharMap_Click(object sender, EventArgs e)
		{
			...
			{
				customstring = File.ReadAllText(a.FileName);
			}
		}
		...
		{
			numericUpDownCodepage.Enabled = radioButtonCustomCodepage.Checked;
		}

		private void radioButtonCustomCharmap_CheckedChanged(object sender, EventArgs e)
		{
			buttonLoadCharMap.Enabled = radioButtonCustomCharmap.Checked;
		}
