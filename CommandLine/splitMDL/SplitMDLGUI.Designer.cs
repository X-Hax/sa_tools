namespace SplitMDL
{
    partial class SplitMDLGUI
    {
        ...
        private void InitializeComponent()
        {
			...
			this.animFilesClear = new System.Windows.Forms.Button();
			this.SuspendLayout();
			// 
			// fileLabel
			// 
			...
			// animFilesClear
			// 
			this.animFilesClear.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			this.animFilesClear.Location = new System.Drawing.Point(411, 164);
			this.animFilesClear.Name = "animFilesClear";
			this.animFilesClear.Size = new System.Drawing.Size(119, 23);
			this.animFilesClear.TabIndex = 11;
			this.animFilesClear.Text = "Clear";
			this.animFilesClear.UseVisualStyleBackColor = true;
			this.animFilesClear.Click += new System.EventHandler(this.animFilesClear_Click);
			// 
			// SplitMDLGUI
			// 
			...
			this.Controls.Add(this.animFilesClear);
