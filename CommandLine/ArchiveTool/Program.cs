    ...
    static partial class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (args.Length == 0 || (args.Length > 0 && (args[0] == "-h" || args[0] == "--help")))
            {
                ...
                Console.WriteLine("Creating an AFS archive: ArchiveTool <file> -afs [-nometa] [-metafirst] [-addmeta]\n-nometa: Don't store filenames and timestamps\n-metafirst: Store metadata pointer before the first file entry instead of the end of the entry table.\n");
				Console.WriteLine("Modifying an AFS archive: ArchiveTool -addmeta <file> <indexfile>\n");
