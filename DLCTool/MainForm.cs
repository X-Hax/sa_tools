...
namespace DLCTool
{
    public partial class MainForm : Form
    {
		...
		private void vMIEditorToolStripMenuItem_Click(object sender, EventArgs e)
		{
            if (vmiEditor == null || vmiEditor.IsDisposed)
                vmiEditor = new VMIEditor(meta);
            vmiEditor.Show();
            vmiEditor.Focus();
		}
