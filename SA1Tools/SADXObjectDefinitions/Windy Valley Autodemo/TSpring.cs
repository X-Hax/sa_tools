...
{
	public class TSpring : ObjectDefinition
	{
		...
		{
			model = ObjectHelper.LoadModel("stg02_windy/common/models_custom/T_Spring.sa1mdl");
		...
		public override string Name { get { return "Spring on Platform"; } }
	}
}