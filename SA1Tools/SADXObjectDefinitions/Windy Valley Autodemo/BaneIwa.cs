...
{
	public class BaneIwa : ObjectDefinition
	{
		...
		{
			model = ObjectHelper.LoadModel("stg02_windy/common/models/wvobj_baneiwa.sa1mdl");
			meshes = ObjectHelper.GetMeshes(model);
		}

		public override string Name { get { return "Floating Rock Spring"; } }
		...
		private readonly PropertySpec[] customProperties = new PropertySpec[] {
			...
			new PropertySpec("Fan Speed", typeof(float), "Extended", null, null, (o) => o.Scale.Z, (o, v) => o.Scale.Z = (float)v)
		};
