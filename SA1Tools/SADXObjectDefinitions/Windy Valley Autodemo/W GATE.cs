...
namespace SADXObjectDefinitions.WindyValleyAutodemo
{
	...
	public class WindyGate1 : GateBase
	{
		...
		{
			model = ObjectHelper.LoadModel("stg02_windy/common/models/kazeroop_kazegate.sa1mdl");
	...
	public class WindyGate2 : GateBase
	{
		public override void Init(ObjectData data, string name)
		{
			model = ObjectHelper.LoadModel("stg02_windy/common/models/kazeroop_kazegate2.sa1mdl");
			meshes = ObjectHelper.GetMeshes(model);
		}
