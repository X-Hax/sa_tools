...
{
	public class Lauchin : ObjectDefinition
	{
		...
		{
			model = ObjectHelper.LoadModel("stg02_windy/common/models/wvobj_banelaunch.sa1mdl");
		...
		public override string Name { get { return "Flat Spring"; } }
	}
}