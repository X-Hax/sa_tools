...
{
	public class WGear : ObjectDefinition
	{
		...
		{
			model = ObjectHelper.LoadModel("stg02_windy/common/models_custom/WGear.sa1mdl");
			meshes = ObjectHelper.GetMeshes(model);
		}
		public override string Name { get { return "Windy Gear"; } }

		private readonly PropertySpec[] customProperties = new PropertySpec[] {
			new PropertySpec("Spin Speed", typeof(float), "Extended", null, null, (o) => o.Scale.Z, (o, v) => o.Scale.Z = (float)v),
