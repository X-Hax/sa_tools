...
{
	public class Ukisim : ObjectDefinition
	{
		...
		{
			model = ObjectHelper.LoadModel("stg02_windy/common/models/wvobj_ukisima.nja.sa1mdl");
		...
		public override string Name { get { return "Grassy Platform"; } }
	}
}