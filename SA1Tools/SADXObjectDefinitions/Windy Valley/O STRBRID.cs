...
{
	public class StoneBridge : ObjectDefinition
	{
		...
		{
			model = ObjectHelper.LoadModel("stg02_windy/common/models/windobj_isibasi.nja.sa1mdl");
		...
		public override string Name { get { return "Stone Bridge"; } }
	}
}