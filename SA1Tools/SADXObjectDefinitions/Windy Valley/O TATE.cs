...
{
	public abstract class Tate : ObjectDefinition
	{
	...
	public class TateS : Tate
	{
		...
		public override string Name { get { return "Rock Fencing (Single)"; } }
	}

	public class TateL : Tate
	{
		public override void Init(ObjectData data, string name)
		{
		...
		public override string Name { get { return "Rock Fencing (Group)"; } }
	}
}