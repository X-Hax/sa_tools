...
{
	public class Kazami : ObjectDefinition
	{
		...
		{
			model = ObjectHelper.LoadModel("stg02_windy/common/models/windobj_kazami.nja.sa1mdl");
		...
		public override string Name { get { return "Windmill (2-Propeller)"; } }
	}
}