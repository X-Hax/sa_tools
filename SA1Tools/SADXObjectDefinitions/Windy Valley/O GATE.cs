...
{
	public class Gate : ObjectDefinition
	{
		...
		{
			model = ObjectHelper.LoadModel("stg02_windy/common/models/kazeroop_kazegate.nja.sa1mdl");
		...
		public override string Name { get { return "Windmill (Gate)"; } }
	}
}