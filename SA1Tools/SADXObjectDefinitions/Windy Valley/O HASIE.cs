...
{
	public class Hasie : ObjectDefinition
	{
		...
		{
			model = ObjectHelper.LoadModel("stg02_windy/common/models/windobj_hasib_end.nja.sa1mdl");
		...
		public override string Name { get { return "Bridge Posts"; } }
	}
}