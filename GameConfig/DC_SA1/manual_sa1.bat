...
..\..\bin\split binary data/SONICADV/M_SBMOT.PRS M_SBMOT.ini output/
..\..\bin\split binary data/SONICADV/S_SBMOT.PRS S_SBMOT.ini output/
echo NB split
..\..\bin\split nb data/SONICADV/E101R.NB output/ -ini B_E101_R_NB.ini
..\..\bin\split nb data/SONICADV/EROBO.NB output/ -ini B_ROBO_NB.ini