...
{
	public class AltStartPosItem : Item
	{
		...
		public AltStartPosItem(NJS_OBJECT model, string textures, float offset, Vertex position, int yrot, Device dev, EditorItemSelection selectionManager, string postype = "Start Position")
