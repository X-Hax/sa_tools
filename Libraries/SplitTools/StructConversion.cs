...
namespace SplitTools
{
	public static class StructConversion
	{
		...
		/// <param name="isNinja2">Use Ninja2-styled data for NJA exports.</param>
		/// <param name="headerdata">Write header data for NJA exports.</param>
		public static void ConvertFileToText(string source, TextType type, string destination = "", bool basicDX = true, bool overwrite = true, bool isNinja2 = false, bool headerdata = false)
		{
			var outext = ".c";
