namespace TextureLib
{
    public enum PvrPixelFormat : byte
    {
		...
		Bump88 = 0x04, 
		/// <summary>
		/// NJD_TEXFMT_RGB_555. Stored like ARGB1555 but with the alpha bit ignored. Haven't seen any PVR files with it.
		/// </summary>
		Rgb555 = 0x05,
		/// <summary>
		/// NJD_TEXFMT_ARGB_8888 or NJD_TEXFMT_YUV_420. NJD_TEXFMT_ARGB_8888 is used in palette PVP files. Neither format is seen in PVR files.
    ...
    public enum PvrDataFormat : byte
    {
		...
		Rectangle = 0x09,
		/// <summary>
		/// NJD_TEXFMT_RECTANGLE_MM. Same as NJD_TEXFMT_RECTANGLE because Rectangle doesn't support mipmaps.
		/// </summary>
		...
		/// <summary>
		/// NJD_TEXFMT_STRIDE_MM. Same as NJD_TEXFMT_STRIDE because Stride doesn't support mipmaps.
		/// </summary>
		...
		Bitmap = 0x0E, 
		/// <summary>
		/// NJD_TEXFMT_ABGR_MM. No known PVR files in this format.
		/// </summary>
		BitmapMipmaps = 0x0F,
		/// <summary>
		/// NJD_TEXFMT_SMALLVQ
		...
		SmallVqMipmaps = 0x11, 
		/// <summary>
		/// NJD_TEXFMT_TWIDDLED_MM_DMA. Twiddled mipmapped DMA texture, contents identical to NJD_TEXFMT_TWIDDLED_MM.
		/// </summary>
