namespace SonicRetro.SAModel.SAEditorCommon.UI
{
	partial class ModelLibraryControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.modelListView.MouseDown += new System.Windows.Forms.MouseEventHandler(this.modelListView_MouseDown);
			this.modelListView.MouseMove += new System.Windows.Forms.MouseEventHandler(this.modelListView_MouseMove);
			// 
			// ModelLibraryControl
			// 
