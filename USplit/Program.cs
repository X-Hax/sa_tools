...
namespace USplit
{
	...
	class Program
	{
		static void AddTransferredLabel(Dictionary<int, string> destinationlist, int address, string name)
		{
			if (!destinationlist.ContainsKey(address)) destinationlist.Add(address, name);
		}
