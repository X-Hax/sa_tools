...
namespace SA2ObjectDefinitions.Common
{
	public class EAKAHIGE : ObjectDefinition
	{
		...
		public override HitResult CheckHit(SETItem item, Vector3 Near, Vector3 Far, Viewport Viewport, Matrix Projection, Matrix View, MatrixStack transform)
		{
			...
			HitResult result = pObject.CheckHit(Near, Far, Viewport, Projection, View, transform, mesh_akahige3);
			transform.Pop();
		...
		{
			texs = ObjectHelper.GetTextures("e_akahigetex");
		...
		private readonly PropertySpec[] customProperties = new PropertySpec[] {
			...
			new PropertySpec(
				...
				"Extended", 
				null, 
				PhoenixType.ThreeBombs, 
				(o) =>
				{
					int phoenixType = (int)o.Scale.X;
					if (phoenixType == 1)
						return PhoenixType.SixBombs;
					else
						return PhoenixType.ThreeBombs;
				}, 
				(o, v) => 
				{
					if ((PhoenixType)v == PhoenixType.SixBombs)
					{
						o.Scale.X = 1;
					}
					else
